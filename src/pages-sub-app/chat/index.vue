<template>
  <view class="page-chat">
    ...
    <view class="quick-skills">
      <text class="skill-btn" @tap="quickAsk('查一下 600519 的行情')">📈 行情</text>
      <text class="skill-btn" @tap="quickAsk('查一下 600519 的资金流向')">💰 资金</text>
      <text class="skill-btn" @tap="quickAsk('今天的龙头股有哪些')">🏆 龙头</text>
    </view>
...
.page-chat { display: flex; flex-direction: column; height: 100vh; background: #f5f7fa; }
.chat-header {
...
.input-bar { display: flex; gap: 12rpx; padding: 16rpx 20rpx; background: #ffffff; box-shadow: 0 -2rpx 8rpx rgba(0, 0, 0, 0.04); }
.input { flex: 1; background: #f5f7fa; border-radius: 12rpx; padding: 16rpx; color: #1a1d24; font-size: 28rpx; }
.send-btn { background: #4d7cfe; color: #fff; border-radius: 12rpx; padding: 0 30rpx; font-size: 28rpx; }
</style>
